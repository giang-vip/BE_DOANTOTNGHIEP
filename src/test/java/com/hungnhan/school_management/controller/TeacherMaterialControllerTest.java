...
@ActiveProfiles("test")
public class TeacherMaterialControllerTest {
    ...
    void getMaterials_ReturnsOk() throws Exception {
        ...
        Mockito.when(teacherMaterialService.getMaterials(any(String.class), eq(1L), eq(0), eq(10))).thenReturn(mockPage);

        mockMvc.perform(get("/api/teacher/classes/1/materials"))
