...
public class StudentAssignmentControllerTest {
    ...
    void getAssignments_ReturnsOk() throws Exception {
        ...
        Mockito.when(studentAssignmentService.getAssignments(any(String.class), eq(1L), eq(0), eq(10))).thenReturn(mockPage);

        mockMvc.perform(get("/api/student/classes/1/assignments"))
